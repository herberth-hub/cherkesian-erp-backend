...
export class CreateFilialDto {
  ...
  @IsOptional() @IsString() @MaxLength(200) focusTokenHomolog?: string;
  @IsOptional() @IsString() @MaxLength(200) focusTokenProd?: string;
  /** Ambiente NF-e da filial: homologacao | producao (sobrepõe o global). */
  @IsOptional() @IsIn(['homologacao', 'producao']) nfeAmbiente?: string;
